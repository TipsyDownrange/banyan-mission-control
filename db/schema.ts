...
// BAN-344a PM-V1.0-E (CORE) — Action Item Tracker entity.  Status enum
// intentionally excludes AUTO_CLOSED in 344a; 344b adds it via ALTER TYPE.
...
export const action_items = pgTable('action_items', {
  ...
  check(
    'action_items_manual_source_id_optional',
    sql`${table.source_entity_type} = 'MANUAL' OR ${table.source_entity_id} IS NOT NULL`,
  ),
]);

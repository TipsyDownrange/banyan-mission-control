      ...
      {sorted.length === 0 ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
          {sorted.map((it) => {
            ...
            return (
              <div key={it.action_item_id} style={{ display: 'grid', gridTemplateColumns: '90px 1fr 110px 110px', gap: 10, alignItems: 'center', padding: '10px 12px', background: overdue ? 'var(--color-red-50)' : 'var(--color-surface)', borderRadius: 10, border: overdue ? '1px solid #fca5a5' : '1px solid var(--color-surface-border)' }}>

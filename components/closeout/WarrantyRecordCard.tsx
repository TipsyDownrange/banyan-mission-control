...
const STATUS_STYLE: Record<WarrantyStatus, { bg: string; color: string; label: string }> = {
  ACTIVE: { bg: 'var(--color-teal-50)', color: 'var(--bos-color-brand-primary-deep)', label: 'Active' },
  PARTIALLY_EXPIRED: { bg: 'var(--color-amber-50)', color: 'var(--color-amber-800)', label: 'Partially expired' },

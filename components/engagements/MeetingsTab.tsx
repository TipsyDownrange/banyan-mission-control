...
export default function MeetingsTab({ kID }: { kID: string }) {
  ...
  if (err) {
    return <div style={{ padding: 24, color: 'var(--color-red-700)', background: 'var(--color-red-50)', borderRadius: 12, border: '1px solid #fecaca' }}>Failed to load meetings: {err}</div>;
  }
  if (!data?.kIDFound) {

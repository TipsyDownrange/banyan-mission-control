...
const STATE_PALETTE: Record<TmTicketState, Palette> = {
  ...
  READY_FOR_GC_APPROVAL: { bg: 'var(--color-amber-50)', color: 'var(--color-amber-800)', label: 'Ready · GC Approval' },
  GC_APPROVED:           { bg: 'var(--color-blue-50)', color: 'var(--bos-color-accent-data-bright)', label: 'GC Approved' },
  DISPUTED:              { bg: '#fff7ed', color: '#c2410c', label: 'Disputed' },
  BILLABLE:              { bg: 'var(--color-blue-50)', color: 'var(--bos-color-accent-data-bright)', label: 'Billable' },
  BILLED:                { bg: 'var(--color-teal-50)', color: 'var(--bos-color-brand-primary-deep)', label: 'Billed' },

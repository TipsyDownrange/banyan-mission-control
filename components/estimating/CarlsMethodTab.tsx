            ...
            <thead>
              <tr>
                <th style={{
                  ...
                  borderBottom: '1px solid var(--color-surface-border)', width: '40%',
                  fontFamily: FONT,
                }}>
                  Item Description
                </th>
                <th style={{
                  ...
                  fontSize: 9, fontWeight: 800, letterSpacing: '0.14em',
                  textTransform: 'uppercase', color: 'var(--bos-color-ink-tertiary)',
                  borderBottom: '1px solid var(--color-surface-border)', width: '22%',
                  fontFamily: FONT,
                }}>
                  Notes
                </th>
                <th style={{
                  ...
                  borderBottom: '1px solid var(--color-surface-border)', width: 90,
                  fontFamily: FONT,
                }}>
                  Market
                </th>
                <th style={{
                  ...
                  fontSize: 9, fontWeight: 800, letterSpacing: '0.14em',
                  textTransform: 'uppercase', color: 'var(--bos-color-ink-tertiary)',
                  borderBottom: '1px solid var(--color-surface-border)', width: 140,
                  fontFamily: FONT,
                }}>
                  Cost
                </th>

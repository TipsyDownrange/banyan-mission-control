...
const INITIAL_TASKS: Task[] = [
  ...
  { id: 'TSK-012', title: 'Service Module — full build', detail: 'Joey's Kanban board for work orders. Lead → Quote → Approved → Scheduled → In Progress → Invoiced → Closed. T&M capture, drive time tracking, shared manpower with PM. Based on whitepaper section 12.1 + Joey's 4 Smartsheet sheets.', status: 'queued', priority: 'high', category: 'Service', assignedTo: 'Kai', createdAt: '2026-04-01', updatedAt: '2026-04-01' },

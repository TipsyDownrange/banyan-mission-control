...
const SEED_TASKS: Task[] = [
  ...
  { id: 'TSK-001', title: 'Estimating Module Architecture', detail: 'Architecture doc completing, full build plan in docs/ESTIMATING_MODULE_ARCHITECTURE.md', status: 'in_progress', priority: 'critical', category: 'Estimating', assignedTo: 'Kai', createdAt: '2026-04-05', updatedAt: '2026-04-05' },
  ...
  // HIGH / QUEUED
  { id: 'TSK-003', title: 'Estimating Module Phase 0-1: Data Layer', detail: 'New schema tables, API routes, backend sheet tabs per architecture doc', status: 'queued', priority: 'high', category: 'Estimating', assignedTo: 'Kai', createdAt: '2026-04-05', updatedAt: '2026-04-05' },
  { id: 'TSK-004', title: 'Estimating Module Phase 2: UI Workspace', detail: 'Card view + tabbed workspace with accordion rows', status: 'queued', priority: 'high', category: 'Estimating', assignedTo: 'Kai', createdAt: '2026-04-05', updatedAt: '2026-04-05' },
  { id: 'TSK-005', title: 'Estimating Module Phase 3: Estimating Kai', detail: 'Department-specific AI with GPT prompt + compliance engine', status: 'queued', priority: 'high', category: 'Estimating', assignedTo: 'Kai', createdAt: '2026-04-05', updatedAt: '2026-04-05' },
  ...
  { id: 'TSK-009', title: "Carl's Method Digitization", detail: "Replicate Jody's 1988 Lotus sheet as Tab 1 in new workbook", status: 'queued', priority: 'high', category: 'Estimating', assignedTo: 'Kai+Sean', createdAt: '2026-04-05', updatedAt: '2026-04-05' },
  ...
  { id: 'TSK-011', title: 'QuickBooks Authorization', detail: 'Jenny hits the connect URL to authorize QBO integration', status: 'waiting', priority: 'high', category: 'Finance', assignedTo: 'Jenny', createdAt: '2026-04-05', updatedAt: '2026-04-05' },

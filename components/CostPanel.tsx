        ...
        <>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(160px,1fr))', gap: 12, marginBottom: 24,
            ...
            {[
              ...
              { label: 'Output tokens', value: fmt(data.totalOutput || 0), helper: 'Generated by Kai' },
              { label: 'Cache read', value: fmt(data.totalCacheRead || 0), helper: 'Saved 90% on these' },
            ].map(s => (
          ...
          <div style={{ marginBottom: 20, padding: '12px 16px', borderRadius: 16, background: 'rgba(240,253,250,0.96)', border: '1px solid rgba(15,118,110,0.2)', display: 'flex', gap: 10 }}>
            ...
            <div style={{ fontSize: 13, color: '#475569', lineHeight: 1.6 }}>
              Cache is saving significant cost — {fmt(data.totalCacheRead || 0)} cache read tokens at $0.30/M vs $3.00/M regular rate. Without caching this session would cost ~${((data.totalCacheRead / 1e6) * 2.70 + data.totalCost).toFixed(0)} more.
            </div>
          </div>

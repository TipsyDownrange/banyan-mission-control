...
export default function LoginPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(160deg,#071722 0%,#0c2330 50%,#102c39 100%)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: 32 }}>
      ...
      <button onClick={handleSignIn} style={{ display: 'flex', alignItems: 'center', gap: 12, background: 'white', color: 'var(--color-ink-primary)', borderRadius: 16, padding: '16px 28px', fontSize: 15, fontWeight: 700, border: 'none', cursor: 'pointer', boxShadow: '0 4px 20px rgba(0,0,0,0.2)' }}>

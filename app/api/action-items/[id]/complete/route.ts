/**
 * BAN-344 PM-V1.0-E — POST /api/action-items/[id]/complete
 *
 * Transitions OPEN / IN_PROGRESS / DEFERRED → COMPLETED.  field_super may
 * complete an action item they were assigned to; pm / admin roles may
 * complete any.
 */
...
export async function POST(
  ...
  // Field super self-complete: only allowed if assigned_to matches actor.

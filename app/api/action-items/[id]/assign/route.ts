/**
 * BAN-344 PM-V1.0-E — POST /api/action-items/[id]/assign
 *
 * Assigns the action item to a user.  If the row is OPEN, transitions to
 * IN_PROGRESS; otherwise the assignment patch is applied without changing
 * state.  Emits ACTION_ITEM_STATE_CHANGED.
 */
...
export async function POST(
  ...
  // Open rows promote to IN_PROGRESS on first assignment; already-active
  // rows just receive the assignment patch via allowSameState.

/**
 * BAN-344a PM-V1.0-E (CORE) — GET/PATCH /api/action-items/[id]
 *
 * GET returns the row + linked source-entity metadata.  PATCH applies
 * allowed-field updates and emits ACTION_ITEM_STATE_CHANGED.  State changes
 * (assign/complete/defer/cancel) go through dedicated POST sub-routes for
 * audit clarity.
 */

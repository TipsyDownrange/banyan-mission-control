/**
 * BAN-344 PM-V1.0-E — GET /api/action-items/by-kid/[kid]
 *
 * Project-scoped action item list for ProjectsPanel.  Returns full row
 * payloads plus an action-required and status summary.  Filters:

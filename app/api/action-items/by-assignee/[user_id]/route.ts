/**
 * BAN-344 PM-V1.0-E — GET /api/action-items/by-assignee/[user_id]
 *
 * Cross-project "My Open Actions" surface.  Returns all action_items
 * assigned to the given user across every engagement in the tenant.
 * Defaults to status IN ('OPEN','IN_PROGRESS'); override with ?status=...
 */

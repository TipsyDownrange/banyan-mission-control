...
export const ROLE_PERMISSIONS_DEFAULTS: Record<string, RolePermission[]> = {
  ...
  super_admin:    ['WARROOM_VIEW', 'WARROOM_TASK_WRITE', 'KB_VIEW', 'KB_WRITE', 'KB_TRIAGE', 'KB_SETUP', 'DAILY_REPORT_VIEW', 'DAILY_REPORT_WRITE', 'CONTACTS_VIEW', 'CONTACTS_WRITE', 'ORG_VIEW', 'ORG_WRITE', 'SUGGESTIONS_VIEW', 'SUGGESTIONS_REVIEW', 'WORK_BREAKDOWN_VIEW', 'WORK_BREAKDOWN_WRITE', 'PM_DOCUMENT_VIEW', 'PM_DOCUMENT_WRITE', 'SCHEDULE_VIEW', 'SCHEDULE_WRITE'],
  business_admin: ['WARROOM_VIEW', 'WARROOM_TASK_WRITE', 'KB_VIEW', 'KB_WRITE', 'KB_TRIAGE', 'DAILY_REPORT_VIEW', 'DAILY_REPORT_WRITE', 'CONTACTS_VIEW', 'CONTACTS_WRITE', 'ORG_VIEW', 'ORG_WRITE', 'SUGGESTIONS_VIEW', 'SUGGESTIONS_REVIEW', 'WORK_BREAKDOWN_VIEW', 'WORK_BREAKDOWN_WRITE', 'PM_DOCUMENT_VIEW', 'PM_DOCUMENT_WRITE', 'SCHEDULE_VIEW', 'SCHEDULE_WRITE'],
  gm:             ['KB_VIEW', 'DAILY_REPORT_VIEW', 'CONTACTS_VIEW', 'ORG_VIEW', 'SUGGESTIONS_VIEW', 'WORK_BREAKDOWN_VIEW', 'SCHEDULE_VIEW'],
  owner:          ['KB_VIEW', 'DAILY_REPORT_VIEW', 'CONTACTS_VIEW', 'ORG_VIEW', 'SUGGESTIONS_VIEW', 'WORK_BREAKDOWN_VIEW', 'SCHEDULE_VIEW'],
  service_pm:     ['KB_VIEW', 'DAILY_REPORT_VIEW', 'DAILY_REPORT_WRITE', 'CONTACTS_VIEW', 'CONTACTS_WRITE', 'ORG_VIEW', 'ORG_WRITE', 'SUGGESTIONS_VIEW', 'SUGGESTIONS_REVIEW', 'WORK_BREAKDOWN_VIEW', 'WORK_BREAKDOWN_WRITE', 'SCHEDULE_VIEW'],
  super:          ['KB_VIEW', 'DAILY_REPORT_VIEW', 'DAILY_REPORT_WRITE', 'CONTACTS_VIEW', 'ORG_VIEW', 'SUGGESTIONS_VIEW', 'WORK_BREAKDOWN_VIEW', 'PM_DOCUMENT_VIEW', 'PM_DOCUMENT_WRITE', 'SCHEDULE_VIEW'],
  pm:             ['KB_VIEW', 'KB_WRITE', 'KB_TRIAGE', 'DAILY_REPORT_VIEW', 'DAILY_REPORT_WRITE', 'CONTACTS_VIEW', 'CONTACTS_WRITE', 'ORG_VIEW', 'ORG_WRITE', 'SUGGESTIONS_VIEW', 'SUGGESTIONS_REVIEW', 'WORK_BREAKDOWN_VIEW', 'WORK_BREAKDOWN_WRITE', 'PM_DOCUMENT_VIEW', 'PM_DOCUMENT_WRITE', 'SCHEDULE_VIEW', 'SCHEDULE_WRITE'],
  estimator:      ['KB_VIEW', 'DAILY_REPORT_VIEW', 'CONTACTS_VIEW', 'CONTACTS_WRITE', 'ORG_VIEW', 'ORG_WRITE', 'SUGGESTIONS_VIEW', 'WORK_BREAKDOWN_VIEW', 'WORK_BREAKDOWN_WRITE', 'SCHEDULE_VIEW'],
  admin_mgr:      ['KB_VIEW', 'DAILY_REPORT_VIEW', 'CONTACTS_VIEW', 'ORG_VIEW', 'SUGGESTIONS_VIEW', 'WORK_BREAKDOWN_VIEW', 'SCHEDULE_VIEW'],
  admin:          ['KB_VIEW', 'DAILY_REPORT_VIEW', 'CONTACTS_VIEW', 'ORG_VIEW', 'SUGGESTIONS_VIEW', 'WORK_BREAKDOWN_VIEW', 'SCHEDULE_VIEW'],
  field:          ['KB_VIEW', 'DAILY_REPORT_VIEW', 'CONTACTS_VIEW', 'ORG_VIEW', 'SUGGESTIONS_VIEW', 'WORK_BREAKDOWN_VIEW', 'SCHEDULE_VIEW'],
  pm_track:       ['KB_VIEW', 'DAILY_REPORT_VIEW', 'CONTACTS_VIEW', 'ORG_VIEW', 'SUGGESTIONS_VIEW', 'WORK_BREAKDOWN_VIEW', 'SCHEDULE_VIEW'],
  sales:          ['KB_VIEW', 'DAILY_REPORT_VIEW', 'CONTACTS_VIEW', 'CONTACTS_WRITE', 'ORG_VIEW', 'ORG_WRITE', 'SUGGESTIONS_VIEW', 'WORK_BREAKDOWN_VIEW', 'SCHEDULE_VIEW'],

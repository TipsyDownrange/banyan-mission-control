...
export type RolePermission =
  ...
  | 'PM_DOCUMENT_VIEW'
  | 'PM_DOCUMENT_WRITE'
  // Scheduling Spine (BAN-374)
  | 'SCHEDULE_VIEW'
  | 'SCHEDULE_WRITE'
  // Customer Pipeline / Inquiries (BAN-376)
  | 'INQUIRY_VIEW'
  | 'INQUIRY_WRITE';
...
export const ROLE_PERMISSIONS_DEFAULTS: Record<string, RolePermission[]> = {
  ...
  super_admin:    ['WARROOM_VIEW', 'WARROOM_TASK_WRITE', 'KB_VIEW', 'KB_WRITE', 'KB_TRIAGE', 'KB_SETUP', 'DAILY_REPORT_VIEW', 'DAILY_REPORT_WRITE', 'CONTACTS_VIEW', 'CONTACTS_WRITE', 'ORG_VIEW', 'ORG_WRITE', 'SUGGESTIONS_VIEW', 'SUGGESTIONS_REVIEW', 'WORK_BREAKDOWN_VIEW', 'WORK_BREAKDOWN_WRITE', 'PM_DOCUMENT_VIEW', 'PM_DOCUMENT_WRITE', 'SCHEDULE_VIEW', 'SCHEDULE_WRITE', 'INQUIRY_VIEW', 'INQUIRY_WRITE'],
  business_admin: ['WARROOM_VIEW', 'WARROOM_TASK_WRITE', 'KB_VIEW', 'KB_WRITE', 'KB_TRIAGE', 'DAILY_REPORT_VIEW', 'DAILY_REPORT_WRITE', 'CONTACTS_VIEW', 'CONTACTS_WRITE', 'ORG_VIEW', 'ORG_WRITE', 'SUGGESTIONS_VIEW', 'SUGGESTIONS_REVIEW', 'WORK_BREAKDOWN_VIEW', 'WORK_BREAKDOWN_WRITE', 'PM_DOCUMENT_VIEW', 'PM_DOCUMENT_WRITE', 'SCHEDULE_VIEW', 'SCHEDULE_WRITE', 'INQUIRY_VIEW', 'INQUIRY_WRITE'],
  gm:             ['KB_VIEW', 'DAILY_REPORT_VIEW', 'CONTACTS_VIEW', 'ORG_VIEW', 'SUGGESTIONS_VIEW', 'WORK_BREAKDOWN_VIEW', 'SCHEDULE_VIEW', 'INQUIRY_VIEW', 'INQUIRY_WRITE'],
  owner:          ['KB_VIEW', 'DAILY_REPORT_VIEW', 'CONTACTS_VIEW', 'ORG_VIEW', 'SUGGESTIONS_VIEW', 'WORK_BREAKDOWN_VIEW', 'SCHEDULE_VIEW', 'INQUIRY_VIEW'],
  service_pm:     ['KB_VIEW', 'DAILY_REPORT_VIEW', 'DAILY_REPORT_WRITE', 'CONTACTS_VIEW', 'CONTACTS_WRITE', 'ORG_VIEW', 'ORG_WRITE', 'SUGGESTIONS_VIEW', 'SUGGESTIONS_REVIEW', 'WORK_BREAKDOWN_VIEW', 'WORK_BREAKDOWN_WRITE', 'SCHEDULE_VIEW', 'INQUIRY_VIEW', 'INQUIRY_WRITE'],
  super:          ['KB_VIEW', 'DAILY_REPORT_VIEW', 'DAILY_REPORT_WRITE', 'CONTACTS_VIEW', 'ORG_VIEW', 'SUGGESTIONS_VIEW', 'WORK_BREAKDOWN_VIEW', 'PM_DOCUMENT_VIEW', 'PM_DOCUMENT_WRITE', 'SCHEDULE_VIEW', 'INQUIRY_VIEW'],
  pm:             ['KB_VIEW', 'KB_WRITE', 'KB_TRIAGE', 'DAILY_REPORT_VIEW', 'DAILY_REPORT_WRITE', 'CONTACTS_VIEW', 'CONTACTS_WRITE', 'ORG_VIEW', 'ORG_WRITE', 'SUGGESTIONS_VIEW', 'SUGGESTIONS_REVIEW', 'WORK_BREAKDOWN_VIEW', 'WORK_BREAKDOWN_WRITE', 'PM_DOCUMENT_VIEW', 'PM_DOCUMENT_WRITE', 'SCHEDULE_VIEW', 'SCHEDULE_WRITE', 'INQUIRY_VIEW', 'INQUIRY_WRITE'],
  estimator:      ['KB_VIEW', 'DAILY_REPORT_VIEW', 'CONTACTS_VIEW', 'CONTACTS_WRITE', 'ORG_VIEW', 'ORG_WRITE', 'SUGGESTIONS_VIEW', 'WORK_BREAKDOWN_VIEW', 'WORK_BREAKDOWN_WRITE', 'SCHEDULE_VIEW', 'INQUIRY_VIEW'],
  admin_mgr:      ['KB_VIEW', 'DAILY_REPORT_VIEW', 'CONTACTS_VIEW', 'ORG_VIEW', 'SUGGESTIONS_VIEW', 'WORK_BREAKDOWN_VIEW', 'SCHEDULE_VIEW', 'INQUIRY_VIEW'],
  admin:          ['KB_VIEW', 'DAILY_REPORT_VIEW', 'CONTACTS_VIEW', 'ORG_VIEW', 'SUGGESTIONS_VIEW', 'WORK_BREAKDOWN_VIEW', 'SCHEDULE_VIEW', 'INQUIRY_VIEW', 'INQUIRY_WRITE'],
  field:          ['KB_VIEW', 'DAILY_REPORT_VIEW', 'CONTACTS_VIEW', 'ORG_VIEW', 'SUGGESTIONS_VIEW', 'WORK_BREAKDOWN_VIEW', 'SCHEDULE_VIEW', 'INQUIRY_VIEW'],
  pm_track:       ['KB_VIEW', 'DAILY_REPORT_VIEW', 'CONTACTS_VIEW', 'ORG_VIEW', 'SUGGESTIONS_VIEW', 'WORK_BREAKDOWN_VIEW', 'SCHEDULE_VIEW', 'INQUIRY_VIEW'],
  sales:          ['KB_VIEW', 'DAILY_REPORT_VIEW', 'CONTACTS_VIEW', 'CONTACTS_WRITE', 'ORG_VIEW', 'ORG_WRITE', 'SUGGESTIONS_VIEW', 'WORK_BREAKDOWN_VIEW', 'SCHEDULE_VIEW', 'INQUIRY_VIEW'],
  catalog_admin:  ['KB_VIEW', 'KB_WRITE', 'KB_TRIAGE', 'DAILY_REPORT_VIEW', 'CONTACTS_VIEW', 'ORG_VIEW', 'SUGGESTIONS_VIEW', 'WORK_BREAKDOWN_VIEW', 'PM_DOCUMENT_VIEW', 'PM_DOCUMENT_WRITE', 'INQUIRY_VIEW'],
  ...
  field_super:    ['KB_VIEW', 'DAILY_REPORT_VIEW', 'CONTACTS_VIEW', 'ORG_VIEW', 'SUGGESTIONS_VIEW', 'WORK_BREAKDOWN_VIEW', 'PM_DOCUMENT_VIEW', 'PM_DOCUMENT_WRITE', 'INQUIRY_VIEW'],
  none:           [],
};

/**
 * BAN-344 PM-V1.0-E — Action Item Tracker write/read gates.
 *
 ...
 * route-level handler additionally allows the assigned_to user to update
 * their own assigned action items (assign-self / complete / defer).
 */

...
export const LEGACY_ACTIVITY_SPINE_EVENT_TYPES = ['wo_completion'] as const;

export const ACTIVITY_SPINE_PATTERN_A_EVENT_TYPES = [
  'PAY_APP_NOTARIZED',
  'PAY_APP_NOTARIZATION_SKIPPED',
  'PAY_APP_SUBMITTED',
  'RETAINAGE_RELEASED',
  'PUNCH_LIST_CLEARED',
  ...
  'VERBAL_AGREEMENT_FOLLOWUP_SENT',
  'VERBAL_AGREEMENT_FORMALIZED',
  'VERBAL_AGREEMENT_RESOLVED',
  // BAN-338 v2c — Pay Apps lien waivers + joint check + external waivers + GC docs
  ...
  // BAN-345 PM-V1.0-F — Document Hub (central document repository)
  'DOCUMENT_UPLOADED',
  'DOCUMENT_LINKED',
  'DOCUMENT_SUPERSEDED',
  // BAN-346 PM-V1.0-G — PM Handoff Receipt (Estimating → PM handoff acceptance)
  'HANDOFF_RECEIPT_CREATED',
  'HANDOFF_RECEIPT_STATE_CHANGED',
] as const;
...
export type LegacyActivitySpineEventType = typeof LEGACY_ACTIVITY_SPINE_EVENT_TYPES[number];
...
export const ACTIVITY_SPINE_LEGACY_EVENT_TYPE_COUNT = LEGACY_ACTIVITY_SPINE_EVENT_TYPES.length;

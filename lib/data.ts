...
export const CREW = [
  // Management
  { id: 'USR-001', name: 'Jody Boeringa', role: 'Owner / President', island: 'Oahu', type: 'management' },
  { id: 'USR-002', name: 'Sean Daniels', role: 'GM / PM', island: 'Oahu', type: 'management' },
  { id: 'USR-003', name: 'Frank Redondo', role: 'Senior PM', island: 'Maui', type: 'management' },
  ...
  { id: 'USR-007', name: 'Nate Nakamura', role: 'Superintendent', island: 'Oahu', type: 'management' },
